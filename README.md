...
Docs are available [here](https://github.com/Sylius/SyliusPluginsBundle/blob/master/Resources/doc/index.md).
...
This bundle uses [GitHub issues](https://github.com/Sylius/SyliusPluginsBundle/issues).
...
License can be found [here](https://github.com/Sylius/SyliusPluginsBundle/blob/master/Resources/meta/LICENSE).

Authors.
--------

The bundle was originally created by [Paweł Jędrzejewski](http://diweb.pl).
See the list of [contributors](https://github.com/Sylius/SyliusPluginsBundle/contributors).
